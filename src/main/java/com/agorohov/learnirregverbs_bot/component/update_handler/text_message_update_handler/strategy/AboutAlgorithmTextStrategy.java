...
public class AboutAlgorithmTextStrategy extends ProcessingStrategyAbstractImpl {
    ...
    protected MessageBuilder strategyRealization(UpdateWrapper wrapper) {
        String textToSend = "ℹ️ " // эмодзи
                ...
                + "  Каждое прохождение теста влияет на статистику /stat - у глагола меняется ранг. Тебе будут чаще попадаются глаголы с более низким рангом.\n\n"
                + "  Во время теста тебе нужно выбрать 3 формы неправильного глагола в правильном порядке, нажав на 3 кнопки. "
